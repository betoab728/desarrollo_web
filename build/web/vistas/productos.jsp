<%-- 
    Document   : productos
    Created on : 23/05/2023, 04:16:23 PM
    Author     : ELIAS
--%>

<%@page import="java.util.Iterator"%>
<%@page import="com.sys.model.Producto"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.sys.pruebadao.ProductosDAO"%>
    ...
    <div class="container my-5" >
            ...
            <div class="container">
                ...
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <input type="text" placeholder="Buscar por descripcion" name="buscar" class="form-control" value=""> 
                        </div>
                        <div class="col-sm-3">
                            <input type="submit" class="btn btn-primary" name="btn_buscar" value="Buscar">
                            <a class="btn btn-primary"  href="UsuarioController?accion=NuevoProducto">Nuevo Producto</a>
                        </div>
                    </div>
                    ...
                    <tr>
                        ...
                        <td> 
                            <a href="../ProductoController?accion=editar&id=<%= producto.getIdproducto() %>" class="btn btn-success" ><i class="fas fa-edit"></i></a>
                             <a class="btn btn-danger deletebtn"><i class="far fa-trash-alt"></i></a>
                        </td>
                    </tr>
                    <% } %>
                </tbody>
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    ...
                    <form action="eliminar.php" method="POST">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name="deletedata">Si, eliminar</button>
                        </div>
                    </form>
            </div>
        </div>
