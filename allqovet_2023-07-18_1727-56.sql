...
INSERT INTO `correlativo` VALUES (1,1,30,'NV-001','F-001',0,'B001',1);
...
INSERT INTO `permiso` VALUES (7,2,'0',25,'1','1'),(8,2,'0',26,'1','1'),(9,2,'0',27,'1','0'),(10,2,'0',28,'1','1'),(11,2,'0',29,'1','1'),(12,2,'1',30,'2','1'),(13,2,'1',31,'2','1'),(14,2,'1',32,'3','1'),(15,2,'1',33,'3','1'),(16,2,'1',34,'3','1'),(17,2,'1',35,'3','1'),(18,2,'1',36,'4','1'),(19,2,'1',37,'4','1'),(20,2,'1',38,'5','1'),(21,2,'1',39,'5','0'),(22,2,'1',40,'5','0'),(23,2,'1',41,'5','0'),(24,2,'1',42,'5','0'),(25,2,'1',43,'6','1'),(26,2,'1',44,'6','1'),(27,2,'1',45,'6','1'),(28,2,'1',46,'7','1'),(29,2,'1',47,'7','1'),(30,2,'1',48,'7','1'),(31,2,'1',49,'7','1'),(32,2,'1',50,'8','1'),(33,2,'1',51,'8','1'),(34,2,'1',52,'8','1'),(35,2,'1',53,'8','1'),(36,2,'1',54,'9','1'),(37,2,'1',55,'9','1'),(38,1,'1',25,'1','1'),(39,1,'1',26,'1','1'),(40,1,'1',27,'1','0'),(41,1,'1',28,'1','1'),(42,1,'1',29,'1','1'),(43,1,'1',30,'2','1'),(44,1,'1',31,'2','1'),(45,1,'1',32,'3','1'),(46,1,'1',33,'3','1'),(47,1,'1',34,'3','1'),(48,1,'1',35,'3','1'),(49,1,'1',36,'4','1'),(50,1,'1',37,'4','0'),(51,1,'0',38,'5','1'),(52,1,'0',39,'5','0'),(53,1,'0',40,'5','0'),(54,1,'0',41,'5','0'),(55,1,'0',42,'5','0'),(56,1,'1',43,'6','0'),(57,1,'1',44,'6','0'),(58,1,'1',45,'6','0'),(59,1,'1',46,'7','0'),(60,1,'1',47,'7','0'),(61,1,'1',48,'7','0'),(62,1,'1',49,'7','0'),(63,1,'0',50,'8','0'),(64,1,'0',51,'8','0'),(65,1,'0',52,'8','1'),(66,1,'0',53,'8','0'),(67,1,'0',54,'9','0'),(68,1,'0',55,'9','0');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_ActualizarPermisosMenu` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_ActualizarPermisosMenu`(pIdnivel int,pValor1 char(1),pValor2 char(1),pValor3 char(1),pValor4 char(1)
,pValor5 char(1),pValor6 char(1),pValor7 char(1),pValor8 char(1),pValor9 char(1) )
BEGIN
update permiso set permiso_menu=pValor1 where idmenu='1' and idnivel=pIdnivel;
update permiso set permiso_menu=pValor2 where idmenu='2' and idnivel=pIdnivel;
update permiso set permiso_menu=pValor3 where idmenu='3' and idnivel=pIdnivel;
update permiso set permiso_menu=pValor4 where idmenu='4' and idnivel=pIdnivel;
update permiso set permiso_menu=pValor5 where idmenu='5' and idnivel=pIdnivel;
update permiso set permiso_menu=pValor6 where idmenu='6' and idnivel=pIdnivel;
update permiso set permiso_menu=pValor7 where idmenu='7' and idnivel=pIdnivel;
update permiso set permiso_menu=pValor8 where idmenu='8' and idnivel=pIdnivel;
update permiso set permiso_menu=pValor9 where idmenu='9' and idnivel=pIdnivel;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_AnularMovimientoVenta` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_AnularMovimientoVenta`(pIdventa int)
BEGIN
update movimiento set estado='0' where Idventa=pIdventa;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_AnularPago` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_AnularPago`(pIdventa int)
BEGIN
	update operacion set Estado='0' where Idventa=pIdventa;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_AnularVenta`(pIdventa int, pIdusuario int, pMotivo varchar(200))
BEGIN
update venta set estado='0', IdUsuarioAnula=pIdusuario,motivo=pMotivo where Idventa=pIdventa ;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
select p.codigo CODIGO,p.Descripcion DESCRIPCION, m.Nombre MARCA,c.Nombre CATEGORIA ,PrecioVenta PRECIO,DATE_FORMAT(p.FechaVencimiento, '%d/%m/%Y')  VENCIMIENTO, Idproducto
from producto p 
...
BEGIN
select p.Idproducto,p.codigo,concat_ws(' ',p.Descripcion,m.Nombre) producto,p.PrecioCosto,p.PrecioVenta,coalesce(pv.Stock,0) stock,manejastock
from producto p 
inner join marca m on m.Idmarca=p.Idmarca
...
,if(v.estado='1','EFECTUADA','ANULADA')ESTADO,u.Nombre USUARIO,v.motivo MOTIVO  
from venta v
inner join cliente c on v.Idcliente=c.idCliente
inner join trabajador t on v.Idtrabajador=t.Idtrabajador
left join usuario u on v.IdUsuarioAnula=u.Idusuario
...
BEGIN
select dv.Idproducto IDPRODUCTO,p.codigo CODIGO, dv.Descripcion DESCRIPCION,dv.cantidad CANTIDAD,dv.Precio PRECIO,(dv.cantidad * dv.Precio ) IMPORTE
,pv.Idvitrina
 from
detalleventa dv 
inner join producto p on dv.Idproducto=p.Idproducto
inner join productovitrina pv on p.Idproducto=pv.Idproducto
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_ListarMenu` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_ListarMenu`(pIdnivel int)
BEGIN
select distinct m.idmenu,m.nombre, m.descripcion,p.permiso_menu  from menu m
inner join permiso p on m.idmenu=p.idmenu where p.idnivel=pIdnivel;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_ListarSubmenus` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_ListarSubmenus`(pIdnivel int)
BEGIN
select distinct s.idsubmenu,s.nombre,s.descripcion,s.idmenu,p.permiso_submenu
from submenu s 
#inner join menu m on m.idmenu = s.idmenu
inner join permiso p on p.idsubmenu=s.idsubmenu where p.idnivel=pIdnivel;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_ListarSumenus` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_ListarSumenus`()
BEGIN
select * from submenu;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_ListarVitrinas` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_ListarVitrinas`()
BEGIN
select * from vitrina;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_PermisoAnulacion` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_PermisoAnulacion`(pClave varchar(100))
BEGIN
select u.Idusuario
 from usuario u
 inner join nivelacceso n on u.Idnivelacceso=n.Idnivel
 where u.Contraseña=pClave and n.Idnivel='2'; #nivel 2 es administrador
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_ProductoCaducidad` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_ProductoCaducidad`(pFecha date)
BEGIN
DECLARE m INT;
    DECLARE y INT;
    ...
    SET m = MONTH(pFecha);
    SET y = YEAR(pFecha);
select p.codigo CODIGO,p.Descripcion DESCRIPCION, m.Nombre MARCA,c.Nombre CATEGORIA ,PrecioVenta PRECIO,DATE_FORMAT(p.FechaVencimiento, '%d/%m/%Y')  VENCIMIENTO, (v.descripcion) UBICACION
from producto p 
inner join marca m on m.Idmarca=p.Idmarca
inner join categoria c on p.Idcategoria=c.Idcategoria
inner join productovitrina pv on pv.idproducto = p.idproducto
inner join vitrina v on v.idvitrina = pv.idvitrina
WHERE YEAR(p.FechaVencimiento) = y AND MONTH(p.FechaVencimiento) = m;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_RegistrarProducto`(pDescripcion varchar(100),pIdmarca int (11), pIdcategoria int(11), pPrecioCosto decimal(10,2),
 pPrecioVenta decimal(10,2), pFechaVencimiento date,pCodigo varchar(20),pManejaStock char(1),pStockMinimo int,out pIdproducto int)
BEGIN
insert into producto (Descripcion, Idmarca, Idcategoria, PrecioCosto, PrecioVenta, FechaVencimiento,codigo,stock_minimo,manejastock) 
values (pDescripcion, pIdmarca, pIdcategoria, pPrecioCosto, pPrecioVenta, pFechaVencimiento,pCodigo,pStockMinimo,pManejaStock);
select LAST_INSERT_ID() into pIdproducto;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_RegistrarUbicacion` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`admin`@`%` PROCEDURE `sp_RegistrarUbicacion`(pIdproducto int,pIdvitrina int)
BEGIN
insert into productovitrina(Idproducto,Idvitrina,Stock) values (pIdproducto,pIdvitrina,0);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2023-07-18 17:28:21
